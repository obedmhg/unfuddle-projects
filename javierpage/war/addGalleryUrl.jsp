...
<div class="bg-content">
    ...
    <div class="row">
          <div class="span12"> 
			<form action="/addGalleryUrl"  method="post" id="addForm">
		Contraseña <input type="text" name="password" id="password"></input><br>
		Direccion&nbsp;&nbsp;&nbsp; <input type="text" name="url" id="url"></input><br>
		<input type="submit" value="Guardar" id="actionButton"/>
	</form>
      </div>
        </div>
  </div>
