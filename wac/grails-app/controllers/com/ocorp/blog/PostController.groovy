...
class PostController {
	...
	def showImage = {
		Post imagenInstance = Post.get(params.id)
		if(imagenInstance != null) {
			response.outputStream << imagenInstance.getMedia()
    ...
    def update() {
		...
		def prevMedia = postInstance.getMedia()
        postInstance.properties = params
		if (prevMedia !=  null && (params.media == null || params.media.bytes.length == 0)) {
			postInstance.setMedia(prevMedia)
		}
